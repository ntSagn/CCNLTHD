        ...
        <nav className="bg-white shadow-md p-4">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <ul className="flex space-x-6">
              <li>
                <Link to="/" className="text-lg hover:text-blue-500 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/todo" className="text-lg hover:text-blue-500 transition-colors">
                  Todo List
                </Link>
              </li>
              <li>
                <Link to="/weather" className="text-lg hover:text-blue-500 transition-colors">
                  Weather App
                </Link>
              </li>
              <li>
                <Link to="/tictactoe" className="text-lg hover:text-blue-500 transition-colors">
                  Tic Tac Toe
                </Link>
              </li>
              <li>
                <Link to="/profile" className="text-lg hover:text-blue-500 transition-colors">
                  User Profile
                </Link>
              </li>
            </ul>
